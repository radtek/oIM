/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: main.c,v 1.1.2.2 2005/07/05 21:15:06 ehyche Exp $ 
 *   
...
{
	printf("\nUsage:\n");
	printf(">> aacdec infile.aac outfile.pcm\n");
}
...
BOOL NLedGetDeviceInfo(int nID, void *pOutput); 
BOOL NLedSetDevice(int nID, void *pOutput);
