...
typedef DWORD				EID, *PEID;		// Employee ID
typedef DWORD               DID, *PDID;		// Department ID
//typedef DWORD				GID, *PGID;		// Group ID
//typedef unsigned __int64	FID, *PFID;		// File ID
//typedef unsigned __int64	SID, *PSID;		// Session ID
//typedef unsigned __int64	MID, *PMID;		// Message ID
