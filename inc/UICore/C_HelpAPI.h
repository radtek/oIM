...
public:
	...
	inline BOOL		ShowRelayWnd(LPCTSTR pszXml);
	inline BOOL		ShowViewer(LPCTSTR pszImage, QFID fid=0);
	...
	inline UINT		MapKeyState();
	inline BOOL 	GetHotkeyString(eIMString& szHotkey, int& i32Key, int& i32KeyState);
